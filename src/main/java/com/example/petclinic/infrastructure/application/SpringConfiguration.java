...
import com.example.petclinic.domain.logic.appointment.AppointmentsViewFacade;
...
class SpringConfiguration {
    ...
    @Bean
    AppointmentsView appointmentsView(ListAppointmentsPort port) {
        return new AppointmentsViewFacade(port);
    }
}
